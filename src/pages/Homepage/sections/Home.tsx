...
const Section: React.FC = () => {
  return (
    <HomeContainer height="95">
      <Container>
        <Text fontSize="3em" bold marginTop="160px">
          We Create Metaverse Gaming Opportunities for P2E Masses{" "}
        </Text>
        ...
        >
          ...
          <Text as="p" fontSize="1.2em">
            MetaGaming Guild is a unified DAO-based ecosystem of Gaming Guild,
            INO/IGO Launchpad, Gamefi Vaults, Game Yield Farming and
            Play-to-Earn Game aimed at democratizing game finance.
          </Text>
          <Text fontSize="1.2em">
